...
export default function TouchableCompo() {
    ...
    //let make a thing touchable and event occur like
    const pressHandler = (id)=>{
        // console.log(id)
        setpersoninfo((NewPersonList)=>{ return NewPersonList.filter(person=> person.id != id)})
    }
    return (
        <View>
